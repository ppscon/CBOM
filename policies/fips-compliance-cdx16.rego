# ==================================
# FIPS 140-3 Compliance - CycloneDX 1.6
# ==================================
# Enhanced version supporting both CycloneDX 1.4 and 1.6 formats
# Handles component.crypto (1.4) and component.properties (1.6)
#
# FIPS 140-3 (mandatory since April 2022):
# - Replaces FIPS 140-2 with ISO/IEC 19790/24759 alignment
# - September 2026 deadline: 140-2 certificates become historical
# - Includes post-quantum cryptography (PQC) provisions
# - Enhanced self-testing: Pre-Operational Self-Tests (POST) + Conditional Self-Tests
# - Explicit container/cloud deployment support
